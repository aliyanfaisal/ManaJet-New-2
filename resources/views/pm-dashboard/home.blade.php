                                ...
                                <x-fancy-table-body>
                                    ...
                                    {{-- @dd($project->team) --}}
                                        <tr>
                                                ...
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        ...
                                                        <div class="widget-content-left flex2">
                                                            <div class="widget-heading">{{$project->project_name}}</div>
                                                            <div class="widget-subheading opacity-7">
                                                                <b>Lead: </b>{{$project->team->name}}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route("project.edit",['project'=>$project->id]) }}" type="button" id="PopoverCustomT-2"
