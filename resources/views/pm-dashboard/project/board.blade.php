        ...
        <div>
            @php
                ...
                if (Auth::user()->userCan('can_add_project') || Auth::user()->isTeamLead($project->team_id)) {
                    $tabb =
                        ' <span>
                                                <button onclick="deleteResource(\'project_del_' .
                        $project->id .
                        '\')"
                ...
                <div class="row px-4">
                    <div class="col-md-4 mb-3 border border-info">
                        ...
                        <div class="text-center">
                            <div class="">
                                <img width="180" class="rounded-circle" src="{{ $project->projectImageUrl() }}"
                                    alt="">
                            </div>

                            <div class="">
                                <h5 class="font-weight-bold">{{ $project->project_name }}</h5 class="font-weight-bold">
                                <p>
                    ...
                    <div class="col-md-8 mb-3 border ">
                        ...
                        <div>
                            ...
                            <x-card title="<h4><b>Project Ticket</b></h4>" classes="border border-info">
                                            ...
                                            @foreach ($tickets as $ticket)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <button type="button" id="edit" data-json="{{ $ticket->toJson() }}"
                                                            class="btn btn-primary btn-sm">
                                                            Edit/View
                                                        </button>
                                                        
                                                        <form class="d-inline-block" action="{{route('tickets.submit')}}" method="post">
                                                            @csrf
                                                            <input type="text" hidden name="ticket_id" value="{{$ticket->id}}">
                                                            <input value="@if ($ticket->status != 'complete'){{'complete'}}@else{{"pending"}}@endif" hidden name="status">
                                                            <button type="submit" class="btn btn-danger btn-sm">
                                                                Mark @if ($ticket->status != 'complete'){{'Complete'}}@else {{'Pending'}} @endif
                                                            </button>
                                                            </form>
